...
// TODO: Drop the compilation guards?
#ifdef INPUT_PROP_SEMI_MT
const char *props[INPUT_PROP_MAX + 1] = {
...
const char *forcestatus[FF_STATUS_MAX + 1] = {
